...
INPUT_PRODUCTS = "data/raw/tiki_products_book.csv"
OUTPUT_REVIEWS = "data/raw/tiki_reviews_book.csv"


def crawl_reviews_by_product(product_id, product_name, max_pages=2):
