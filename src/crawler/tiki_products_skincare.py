...
OUTPUT_PRODUCTS = "data/raw/tiki_products_skincare11.csv"


def crawl_skincare_products(max_pages=100):

    products = []

    for page in tqdm(range(1, max_pages + 1), desc="Crawling skincare"):
...
if __name__ == "__main__":
    ...
    products = crawl_skincare_products(max_pages=100)
